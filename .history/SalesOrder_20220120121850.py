...
class Sale:
          ...
          def __init__(self, product, client, qty, tax, discount,fromInventoryLocation='',fromInventoryName=''):
          ...
          def getSaleProductLocation(self):
                    return self.getSaleProductLocation()
