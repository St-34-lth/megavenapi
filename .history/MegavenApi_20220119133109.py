...
class MegavenApi:
          ...
          def contactPersonUpdate(self,contact):
                    endPoint = "Contact/ContactPersonUpdate"
                    method = 'post'
                    if contact.getType()=='person':
                              
                              # mvContactPerson = {"ContactID":contact.getId(),"
                              
                              
                              # payload = {'APIKEY':self._apiKey['APIKEY'],'mvContactPerson':{'ContactPersonID':contact.getId(),'ContactPersonName':contact.getName(),'ContactPersonAddress':contact.getAddress(),'ContactPersonPhone':contact.getPhone()}}
