          ...
          def insertSupplierClient(self,supplier,action):
                    ...
                    if supplier != None:
                              try:
                                        ...
                                        for i in range(len(supplierContacts)):
                                                  ...
                                                  "mvSupplierClient":
                                                            {
                                                                      ...
                                                                      'SupplierClientShippingAddress': '',
                                                            }
                                                  }
                                        
                                        supplierAddresses = supplier.getSupplierClientAddresses()
                                        for i in range(len(supplierAddresses)):
                                                  address=supplierAddresses[i]
                                                  
                                                  addressType = address.getAddressType()
                                                  
                                                  if addressType == 'shipping':
                                                            mvSupplierClient['SupplierClientShippingAddress'] = address.getAddressLocation()
                                                  elif addressType == 'billing':
                                                            mvSupplierClient['SupplierClientBillingAddress'] = address.getAddressLocation()
