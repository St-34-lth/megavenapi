...
# insert new contact 
babis = Contact('babis','person',isPrimary=True,
                phone='1235698967', email='notBabis2@exampletest.com', address='Example 20, Athens')
...
s = SupplierClient('Babis','client',[billingAd,shippingAd],[babis])
s.makeSupplierClient('Insert')
