          ...
          def makeSalesOrder(self, action,sale):
                              ...
                              [
                                        {
                                                  ...
                                                  "SalesOrderTotalTaxAmount": "double",#sale.get totalax
                                                  "SalesOrderRowTotalDiscountAmount": "double",#sale.get total disco
                                                  "SalesOrderRowTotalAmount": "double",#sale.getNetprice
                                        }
                              ]
                    }
                    ...
                    mvSalesOrder= {"mvSalesOrder": 
                              {  
                                        ...
                                        "SalesOrderClientName": "string",#client name
