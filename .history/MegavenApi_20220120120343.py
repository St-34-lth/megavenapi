...
class MegavenApi:
          ...
          def makeSalesOrder(self, action,sale):
                    ...
                    mvSalesOrder= {"mvSalesOrder": 
                              {  
                                        "SalesOrderId": sale.getSaleID(), #sale.getSaleId
                                        "SalesOrderNo": sale.getSaleOrderNo(),#sale.getSaleOrderNo
                                        "SalesOrderClientID": sale.getSaleClientID(),#clientID
                                        "SalesOrderClientName": sale.getSaleClientName()",#client name
                                        "SalesOrderBillingAddress": "string",#client b address
                                        "SalesOrderShippingAddress": "string",#client s address
                                        "SalesOrderTotalQuantity": "double",#sale.getqty
                                        "SalesOrderAmountSubtotalWithoutTaxAndDiscount": "double",#sale get nominal price
                                        "SalesOrderAmountTotalDiscount": "double", #sale. get discount value
                                        "SalesOrderAmountTotalTax": "double",#sale . get tax value
                                        "SalesOrderAmountGrandTotal": "double",#sales price
