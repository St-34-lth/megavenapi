...
class MegavenApi:
                                        ...
                                        mvSupplierClient ={ "mvSupplierClient":
                                                            {
                                                                      ...
                                                                      'SupplierClientEmail':supplier.getSupplierPrimaryContact().getContactEmail(),
                                                                      'SupplierClientPhone1': supplier.getSupplierPrimaryContact().getContactPhone(),
          ...
          @staticmethod 
          def getSalesOrderInfo(filters):
                    method = 'post'
                    endPoint ='SalesOrder/SalesOrderGet'
          ...
          # @staticmethod
          # def makeQuoteOrder(sale,action):
                    # method = 'post'
                    # endPoint = 'SalesQuote/SalesQuoteUpdate'
                    # mvRecordAction = {'mvRecordAction': action}
                    # #  "SalesOrderTypeId": 3,
                    ...
                    # SalesQuoteDetails = [
                    # {
                    #           "SalesQuoteRowProductID": sale.getSaleProductID(),
                    #           "SalesQuoteRowProductSKU": sale.getSaleProductSKU(),
                    #           "SalesQuoteRowProductDescription": sale.getSaleProductDescription(),
                    #           "SalesQuoteRowQuantity": sale.getSaleTotalQty(),
                    #           "SalesQuoteRowUnitPriceWithoutTaxOrDiscount": sale.getSaleNominalPrice(),
                    #           "SalesQuoteTotalTaxAmount": sale.getSaleTaxAmount(),
                    #           "SalesQuoteRowTotalDiscountAmount": sale.getSaleDiscountAmount(),
                    #           "SalesQuoteRowTotalAmount": sale.getSaleFinalPrice(),
                    # }
                    # ]
                    ...
                    # mvSalesQuote = {"mvSalesQuote":
                    #                     {
                    #                     "SalesQuoteId": 3,
                    #                     "SalesQuoteTypeId": 3,
                    #                     "SalesQuoteTypeAbbreviation": "SO",
                    #                     "SalesQuoteTypeDescription": "Sales Order",
                    #                     "SalesQuoteNo": sale.getSaleOrderNo(),


                    #                     "SalesQuoteStatus": "Pending",
                    #                     "SalesQuoteClientName": sale.getSaleClientName(),
                    #                     "SalesQuoteInventoryLocationID": sale.getSaleProductLocationID(),
                    #                     "SalesQuoteBillingAddress": sale.getSaleClientAddress('billing'),
                    #                     "SalesQuoteShippingAddress": sale.getSaleClientAddress('shipping'),
                    #                     "SalesQuoteTotalQuantity": sale.getSaleTotalQty(),
                    #                     "SalesQuoteAmountSubtotalWithoutTaxAndDiscount": sale.getSaleNominalPrice(),
                    #                     "SalesQuoteAmountTotalDiscount": sale.getSaleDiscountAmount(),
                    #                     "SalesQuoteAmountTotalTax": sale.getSaleTaxAmount(),
                    #                     "SalesQuoteAmountGrandTotal": sale.getSaleFinalPrice(),
                    #                     "SalesQuoteDetails": SalesQuoteDetails,
                    #                     "SalesQuoteShipDocumentTypeID": 3,
                    #                     }
                    #                     }
                    # payload = dict(MegavenApi._apiKey, **
                    #           mvSalesQuote, **mvRecordAction)
                    # response = MegavenApi.fetch(method,payload,endPoint)
                    # return response
          @staticmethod  
