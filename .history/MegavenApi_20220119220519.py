...
class MegavenApi:
          ...
          def getSupplierClientInfo(self,supplier):
                    method='get'
                              ...
                              [
                                        {
                                                  ...
                                                  "SearchValue":supplier.getSupplierClientName()
                                        }
                              ]
                    }
                    ...
                    self.saveResponse(response.text,f'{supplier.getSupplierClientName()}','json')
                     
                    return(response.content['mvSupplierClients'][0]['SupplierClientID'])
                    # return response.text

          def makeSalesOrder(self, action,client, product, qty):
                    method='post'
                    endPoint = 'SalesOrder/SalesOrderUpdate'
                    clientID = self.getSupplierClientInfo(self,client)
                    ...
                    SalesOrderDetails = {
                              [
                                        {
                                                  "SalesOrderRowProductID": product.getProductID(),
                                                  "SalesOrderRowProductSKU": product.getProductSKU(),
                                                  "SalesOrderRowProductDescription": product.getProductDescription(),
                                                  "SalesOrderRowQuantity": qty,
                                                  "SalesOrderRowShippedQuantity": qty,
                                                  "SalesOrderRowUnitPriceWithoutTaxOrDiscount": product.getProductSalesPrice(),
                                                  "SalesOrderRowTaxID": "int",
                                                  "SalesOrderTotalTaxAmount": "double",
                                                  "SalesOrderRowDiscountID": "int",
