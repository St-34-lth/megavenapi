...
class MegavenApi:
          ...
          def fetch(self, method, payload=dict(), endPoint=""):
              ...
              if method=="post":
                    ...
                    headers= {"APIKEY":self._apiKey['APIKEY'],'format':form['format']}
                    
                    res = self._session.post(url,json=json.dumps(payload),headers=headers)
                    print(res.url)
...
#      
          def insertProduct(self,product):
                    ...
                    payload = dict( **mvProduct, **mvRecordAction, **productSellingPrice)
