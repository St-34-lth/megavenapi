...
babis = Contact('babis', 3, 'Example 8, Athens', 'person',
                contactdetails={'phone':'1235698967','email': 'babis@exampletest.com'})
...
item = Contact('Test Project Location',1,'Example 20, Athens','item',contactdetails={'abbrvn':'Test'})

print(item.getAddress(),item.getAddressType(),item.getId(),item.getType(),item.getAbbrvn())