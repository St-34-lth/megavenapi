...
# A class to hold all data related to a Discount in the megaventory API. Derived from Surcharge class
class Discount(Surcharge):
          ...
          def insertDiscount(self):
                    MegavenApi.updateDiscount(self,'Insert')
