...
class MegavenApi:
          ...
          def getSupplierClientInfo(self,supplier):
                    ...
                    print(response.content['mvSupplierClients'][0]['SupplierClientID'])
          ...
          def makeSalesOrder(self, action,client, product, qty):
                    ...
                    SalesOrderDetails = {
                              [
                                        {
                                                  "SalesOrderRowProductID": "int",
                                                  "SalesOrderRowProductSKU": "string",
                                                  "SalesOrderRowProductDescription": "string",
                                                  "SalesOrderRowQuantity": "double",
                                                  "SalesOrderRowShippedQuantity": "double",
                                                  "SalesOrderRowUnitPriceWithoutTaxOrDiscount": "double",
