...
#     },  
          def insertProduct(self,product):
                    ...
                    mvProduct = {'mvProduct':{'ProductID': f'{product.id}', 'ProductType': f'{product.type}','ProductSKU':f'{product.sku}','ProductDescription':f'{product.description}'}}
                    mvRecordAction = {'mvRecordAction':"Insert"}
                    productSellingPrice = {'ProductSellingPrice':f'{product.price}'}
